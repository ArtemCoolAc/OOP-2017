...
QT_MOC_LITERAL(3, 29, 11), // "file_opened"
QT_MOC_LITERAL(4, 41, 9) // "newconvoy"

    },
    "QtGui\0on_pushButton_clicked\0\0file_opened\0"
    "newconvoy"
};
...
void QtGui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QString _r = _t->on_pushButton_clicked();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->file_opened((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->newconvoy(); break;
        default: ;
        }
    }
}
